...
* Если в промисах нет возвращающихся reject, то функция собирает все результаты промисов
* и резолвит их в качестве массива.
* Если присутствует хоть 1 reject, то все отменяется.
*/
...
* подсчитываем цену для всех продуктов.
*/
