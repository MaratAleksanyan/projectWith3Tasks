/*
* Задача 2
* Было некое недопонимание, противоречие между текстом и примером задачи и по моему
* convert() и import() это одна и та же функция.
* Я реализовал так:
...
* Можно было написать много кейсов для различных проверок, но этого не сделал, так как их много и они разные.
*/
